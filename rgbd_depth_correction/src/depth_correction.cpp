...
public:
  ...
  virtual void onInit()
  {
    ...
    {
      ROS_ERROR("Cannot open configuration files because argument 'filename' not provided and camera 'get_serial' "
                "service not available. Closing depth correction node.");
      return;
    }
