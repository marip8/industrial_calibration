...
#define EXPORT_TARGET_FINDER_PLUGIN(DERIVED_CLASS, ALIAS) EXPORT_CLASS_SECTIONED(DERIVED_CLASS, ALIAS, TARGET_FINDER_SECTION)
...
EXPORT_TARGET_FINDER_PLUGIN(industrial_calibration::ModifiedCircleGridTargetFinderFactory, ModifiedCircleGridTargetFinder)
